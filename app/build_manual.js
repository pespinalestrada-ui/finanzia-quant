...
{ titulo:"Bloque 4 · Matemática de fondo (solo si te pica la curiosidad)", tabs:[
  ...
  { n:"📉 Deriva vol.", nv:"Intermedio",
    ...
    u:"Escribe varios activos separados por comas y pulsa Medir. Marca la casilla para ver, además, hasta cuánto apalancamiento aguanta el primero.",
    ve:["Dos barras por activo: la **media anual** (lo que se publica) y el **CAGR real** (lo que te llevas). Encima, los puntos que se pierden.","SPY se deja 0,6 puntos al año; TQQQ se deja **15,9**. La diferencia entre ambos no es la rentabilidad: es la volatilidad.","La curva de apalancamiento tiene forma de campana: hay un punto óptimo y, pasado otro, apalancar te deja PEOR que no apalancar."],
